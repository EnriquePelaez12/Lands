...
namespace Lands.ViewModels
{
    public class ListaTareasViewModel : BindableObject
    {
        ...
        async public Task<bool> NuevaTareaAsync()
        {
            ...
            try
            {
                nuevaTarea = new Tarea() { Fecha= "", Descripcion = "", Completada = false, Id = 0 };
                ...
                try
                {
                    using (AccesoDatosSqLite dal = new AccesoDatosSqLite())
                    {
                        ...
                        if (tareasBd != null)
                        {
                            ...
                            {
                                Tareas.Add(new TareaViewModel() { Ficha = new Tarea { Id = t.Id, Completada = t.Completada, Descripcion = t.Descripcion, Fecha = t.Fecha } });
                            }
                        }
                    }
                }
